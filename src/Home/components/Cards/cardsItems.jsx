...
const CardsItems = ({ items }) => {
  ...
  return (
    <Link to='/list'>
      <div className="card w-96 bg-base-100 border-[2px] border-gray-300 mt-5">
        ...
        <div className="card-body items-start w-full">
          <div className=" flex gap-24 w-full justify-between">
            <button className="text-sky-400 shadow-sm shadow-green-100">{items.identity}</button>
            <p className="text-sky-400 shadow-sm shadow-green-100">{items.nickname}</p>
          </div>
